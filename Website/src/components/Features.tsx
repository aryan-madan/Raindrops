...
export default function Features() {
    ...
    return (
        <section ref={comp} className="py-32 px-6 w-full max-w-[1200px] mx-auto">
            <div className="features-container grid grid-cols-2 md:grid-cols-4 gap-x-6 gap-y-24">
                {features.map((f, i) => (
                    <div key={i} className="feat-item flex flex-col items-center text-center group cursor-default">
                        <div className="mb-8 text-primary group-hover:scale-110 group-hover:-rotate-3 transition-transform duration-500 ease-in-out p-4 bg-surface rounded-3xl shadow-sm dark:shadow-none">
                            {f.icon}
                        </div>
            ...
            <div className="mt-40 flex justify-center">
                <a href="https://github.com/aryan-madan/Raindrops/releases/" target="_blank" rel="noreferrer" className="bg-primary hover:scale-105 active:scale-95 text-background px-8 py-4 rounded-2xl font-bold text-lg transition-transform duration-300 ease-in-out flex items-center gap-3 shadow-xl shadow-primary/20">
